...
xs=[]
ys=[]
video = cv2.VideoCapture("C:\pythonfiles\c107\PRO-C107-Student-Boilerplate-main\bb3.mp4")
...
def goal_track(img, bbox):
    ...
    print(distance)
    if(distance<20):
        cv2.putText(img,"GOAL",(300,90),cv2.FONT_HERSHEY_SCRIPT_SIMPLEX,0.7,(100,255,255),3)
    xs.append(c1)
    xs.append(c2)
